...
def sizes(rrbs):
    smallest = min([rrb for rrb in rrbs if rrb!=None])
...
def dataset_customization(data_set,labels,biases,errors):
    ...
    if data_set == 'german':
        offsets = [(11,-4), (11,-4), (11,-10), (11,0), (8,-4), (8,-4), (11,-3), (11,0), (0,-19),(11,0),(12,0),(11,0),(11,0),(11,0)]
    ...
    if data_set == 'adult':
        offsets = [(-33,0),(9,0),(9,0),(11,0),(10,0),(11,0),(-1,10),(-5,-20),(10,-10),(11,0),(11,0),(11,0),(9,1),(11,0),(11,0)]
        plt.legend(patches,[alg_type for alg_type in color_map.keys()])
